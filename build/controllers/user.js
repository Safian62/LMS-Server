...
exports.registrationUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        const isEmailExists = await userModel_1.default.findOne({ email });
        if (isEmailExists) {
        ...
        try {
            ...
            res.status(201).json({
                success: true,
                messsage: `Please check your email ${user.email} to activate your account.`,
...
exports.updateAccessToken = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (!session) {
            return next(new ErrorHandler_1.default('please login to access this recourses', 400));
        }
...
exports.deleteUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (!user) {
            return next(new ErrorHandler_1.default('User not found with this id', 400));
        }
